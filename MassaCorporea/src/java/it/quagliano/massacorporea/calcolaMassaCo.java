 ...
 * @author quintaia11
 */
public class calcolaMassaCo extends HttpServlet {
    IMC c;
    /**
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet calcolaMassaCo</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet calcolaMassaCo at " + request.getContextPath() + "</h1>");
            ...
            double IMC=c.calcola(peso, altezza);
